 ...
 */
define('Sage/Platform/Mobile/Models/Properties/Phone', [
    'dojo/_base/declare',
    'dojo/_base/lang',
    ...
    var prop = declare('Sage.Platform.Mobile.Models.Properties.Phone', _PropertyBase, {
    ...
    return PropertyManager.register('Phone', prop);
});
