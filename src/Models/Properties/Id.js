 ...
 */
define('Sage/Platform/Mobile/Models/Properties/Id', [
    'dojo/_base/declare',
    'dojo/_base/lang',
   ...
   var prop = declare('Sage.Platform.Mobile.Models.Properties.Id', _PropertyBase, {
   ...
   return PropertyManager.register('Id', prop);
});
