...
/**
 * @class Sage.Platform.Mobile.Models.Properites.IntegerProperty
 
 * @alternateClassName _PropertylBase
 * @requires Sage/Platform/Mobile/Models/_PropertyBase
 */
define('Sage/Platform/Mobile/Models/Properties/Integer', [
    'dojo/_base/declare',
    'dojo/_base/lang',
    ...
    var prop = declare('Sage.Platform.Mobile.Models.Properties.Integer', _PropertyBase, {
    ...
    return PropertyManager.register('Integer', prop);
});
