 ...
 */
define('Sage/Platform/Mobile/Models/Properties/Picklist', [
    'dojo/_base/declare',
    'dojo/_base/lang',
    ...
    var prop = declare('Sage.Platform.Mobile.Models.Properties.Picklist', _PropertyBase, {
    ...
    return PropertyManager.register('Picklist', prop);
});
